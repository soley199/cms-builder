...
class InstallController{
    ...
    public function install(){
        if(isset($_POST["email_adimin"])){
            // echo '<pre> $_Post '; print_r($_POST); echo'</pre>';
            // echo '<pre>Conexion a DB '; print_r(InstallController::connect()); echo'</pre>';
            /*============================================
            ...
            $sqlAdmins="CREATE TABLE admins (
                ...
                date_updated_admin TIMESTAMP on update CURRENT_TIMESTAMP NOT NULL DEFAULT
                    CURRENT_TIMESTAMP,
            ...
            $sqlPages="CREATE TABLE pages (
                ...
                date_updated_page TIMESTAMP on update CURRENT_TIMESTAMP NOT NULL DEFAULT
                    CURRENT_TIMESTAMP,
                PRIMARY KEY (id_page))";
            ...
            $sqlModules="CREATE TABLE modules (
                ...
                date_updated_module TIMESTAMP on update CURRENT_TIMESTAMP NOT NULL DEFAULT
                    CURRENT_TIMESTAMP,
            ...
            $sqlColumns="CREATE TABLE columns (
                ...
                date_updated_column TIMESTAMP on update CURRENT_TIMESTAMP NOT NULL DEFAULT
                    CURRENT_TIMESTAMP,
            ...
            if($stmtAdmins -> execute() && 
                ...
                $stmtModules-> execute() && 
                $stmtColumns-> execute()){
                // echo"<div class='badge badge-success'> Creación exitosa</div>";
                echo'<script>
                alert("Tablas creada exitosamente");
                </script>';
            }
        }
    }
